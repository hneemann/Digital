...
public class DataFieldImporterTest extends TestCase {
    ...
    public void testCreate16() {
        ...
        DataFieldImporter.ByteArray a = DataFieldImporter.createByteArray(df, 16);
        a.set(0, 0x01);
        a.set(1, 0x10);
        a.set(2, 0x77);
        a.set(3, 0x33);
    ...
    public void testCreate24() {
        DataField df = new DataField(16);
        DataFieldImporter.ByteArray a = DataFieldImporter.createByteArray(df, 24);
        a.set(0, 0x01);
        a.set(1, 0x10);
        a.set(2, 0x77);
        a.set(3, 0x33);
    ...
    public void testCreate32() {
        DataField df = new DataField(16);
        DataFieldImporter.ByteArray a = DataFieldImporter.createByteArray(df, 32);
        a.set(0, 0x01);
        a.set(1, 0x10);
        a.set(2, 0x77);
        a.set(3, 0x33);
