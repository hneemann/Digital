...
public final class Keys {
	...
	/**
	 * Returns the key of the given name. If key does not exist, nul is returned.
	 *
	 * @param name
	 *            the name of the key
	 ...
	 */
	public static final Key.KeyInteger INPUT_COUNT // needs to have the same default value as ADDR_BITS!!! see
													// de.neemann.digital.gui.components.EditorFactory#DataFieldEditor
			= new Key.KeyInteger("Inputs", 2).setComboBoxValues(new Integer[] { 2, 3, 4, 5 }).setMin(2);
	 ...
	 */
	public static final Key.KeyInteger DELAY_TIME = new Key.KeyInteger("delayTime", 1)
			.setComboBoxValues(new Integer[] { 1, 2, 3, 4, 5 }).setMin(1).setMax(20);
	 ...
	 * The font size
	 */
	public static final Key<Integer> FONT_SIZE = new Key.KeyInteger("textFontSize", Style.NORMAL.getFontSize())
			.setComboBoxValues(new Integer[] { 14, 17, 20, 24, 36, 48, 60 }).setMin(10).setMax(70);

	/**
	 * The size of a LED
	 */
	public static final Key<Integer> SIZE = new Key.KeyInteger("Size", 1)
			.setComboBoxValues(new Integer[] { 1, 2, 3, 4, 5 }).setMin(1).allowGroupEdit();

	/**
	 * The value of constants
	 */
	public static final Key<Long> VALUE = new Key<>("Value", 1L).allowGroupEdit();

	/**
	 * The default value of elements
	 */
	public static final Key<Integer> DEFAULT = new Key<>("Default", 0).allowGroupEdit();

	/**
	 * The default value of inputs
	 */
	public static final Key<InValue> INPUT_DEFAULT = new Key<>("InDefault", new InValue(0)).allowGroupEdit();

	/**
	 * The default value of the dip switch
	 */
	public static final Key<Boolean> DIP_DEFAULT = new Key<>("dipDefault", false);
	 ...
	 */
	public static final Key.KeyInteger SPLITTER_SPREADING = new Key.KeyInteger("splitterSpreading", 1)
			.setComboBoxValues(new Integer[] { 1, 2, 3, 4 }).setMin(1).setMax(10);
	 ...
	 */
	public static final Key<Integer> FREQUENCY = new Key.KeyInteger("Frequency", 1)
			.setComboBoxValues(new Integer[] { 1, 2, 5, 10, 20, 50, 100, 200, 500, 5000, 50000, 500000 }).setMin(1)
	 ...
	 */
	public static final Key<Integer> ADDR_BITS = new Key.KeyBits("AddrBits", 2).setMax(24); // needs to have the same
																							// default value as
																							// INPUT_COUNT!!! see
																							// de.neemann.digital.gui.components.EditorFactory#DataFieldEditor
	 ...
	 */
	public static final Key<DataField> DATA = new Key<>("Data", DataField.DEFAULT);
	 ...
	 */
	public static final Key<Rotation> ROTATE = new Key<>("rotation", new Rotation(0)).allowGroupEdit();
	 ...
	 */
	public static final Key.KeyInteger CYCLES = new Key.KeyInteger("Cycles", 100000)
			.setComboBoxValues(new Integer[] { 1000, 10000, 100000, 1000000 });

	/**
	 * flag to make a value a probe
	 */
	public static final Key<Boolean> VALUE_IS_PROBE = new Key<>("valueIsProbe", false).allowGroupEdit();

	/**
	 * flag to set a ROM as program memory
	 */
	public static final Key<Boolean> IS_PROGRAM_MEMORY = new Key<>("isProgramMemory", false);

	/**
	 * flag to enable the ROMs auto load function
	 */
	public static final Key<Boolean> AUTO_RELOAD_ROM = new Key<>("autoReload", false);

	/**
	 * flag to show the data table window
	 */
	public static final Key<Boolean> SHOW_DATA_TABLE = new Key<>("showDataTable", false);

	/**
	 * flag to show the data graph window
	 */
	public static final Key<Boolean> SHOW_DATA_GRAPH = new Key<>("showDataGraph", false);

	/**
	 * flag to show the data graph window in single gate mode
	 */
	public static final Key<Boolean> SHOW_DATA_GRAPH_MICRO = new Key<>("showDataGraphMicro", false);
	 ...
	 */
	public static final Key<Boolean> IS_HIGH_Z = new Key<>("isHighZ", false).allowGroupEdit();
	 ...
	 * shape setting
	 */
	public static final Key<Boolean> SETTINGS_IEEE_SHAPES = new Key<>("IEEEShapes",
			Locale.getDefault().getLanguage().equals(Locale.US.getLanguage()));

	/**
	 * The GUI Language
	 */
	public static final Key<Language> SETTINGS_LANGUAGE = new Key<>("Language", new Language());
	 ...
	 */
	public static final Key<FormatToExpression> SETTINGS_EXPRESSION_FORMAT = new Key<>("ExpressionFormat",
			FormatToExpression.FORMATTER_UNICODE);

	/**
	 * enables the grid
	 */
	public static final Key<Boolean> SETTINGS_GRID = new Key<>("grid", false);
	 ...
	 */
	public static final Key.KeyEnum<IntFormat> INT_FORMAT = new Key.KeyEnum<>("intFormat", IntFormat.def,
			IntFormat.values());

	/**
	 * width of the terminal
	 */
	public static final Key.KeyInteger GRAPHIC_WIDTH = new Key.KeyInteger("graphicWidth", 160).setMin(5);

	/**
	 * height of the terminal
	 */
	public static final Key.KeyInteger GRAPHIC_HEIGHT = new Key.KeyInteger("graphicHeight", 100).setMin(5);
	 ...
	 */
	public static final Key<BarrelShifterMode> BARREL_SHIFTER_MODE = new Key.KeyEnum<>("barrelShifterMode",
			BarrelShifterMode.logical, BarrelShifterMode.values());

	/**
	 * flag used by a barrel shifter to indicate shift direction
	 */
	public static final Key<LeftRightFormat> DIRECTION = new Key.KeyEnum<>("direction", LeftRightFormat.left,
			LeftRightFormat.values());
	 ...
	 */
	public static final Key<Boolean> COMMON_CATHODE = new Key<>("commonCathode", false).allowGroupEdit();

	/**
	 * Used to enable the storage of the last state in the Seven Seg display.
	 */
	public static final Key<Boolean> LED_PERSISTENCE = new Key<>("ledPersistence", false).allowGroupEdit();

	/**
	 * Fitter for the atf1502
	 */
	public static final Key<File> SETTINGS_ATF1502_FITTER = new Key.KeyFile("atf1502Fitter",
			new File("c:/Wincupl/WinCupl/Fitters")).setDirectoryOnly(true);
	 ...
	 * the pin number
	 */
	public static final Key<String> PINNUMBER = new Key<>("pinNumber", "");

	/**
	 * true if shape is a dil shape
	 */
	public static final Key<Boolean> IS_DIL = new Key<>("isDIL", false);
	/**
	 * the pin count
	 */
	public static final Key<Integer> PINCOUNT = new Key.KeyInteger("pinCount", 0).setMin(0).setDependsOn(IS_DIL);

	/**
	 * contains the input inverter config
	 */
	public static final Key<InverterConfig> INVERTER_CONFIG = new Key<>("inverterConfig", new InverterConfig());

	/**
	 * Background Color of nested circuits
	 */
	public static final Key<java.awt.Color> BACKGROUND_COLOR = new Key<>("backgroundColor",
			new Color(255, 255, 180, 200)).setDependsOn(IS_DIL, true);

	/**
	 * the screen resolution
	 */
	public static final Key<Integer> SETTINGS_FONT_SCALING = new Key.KeyInteger("fontSize",
			Screen.getDefaultFontScaling()).setComboBoxValues(new Integer[] { 100, 120, 150, 180, 200, 250, 300 })
					.setMin(50).setMax(400);
	 ...
	 * Fitter for the atf1502
	 */
	public static final Key<File> SETTINGS_LIBRARY_PATH = new Key.KeyFile("libraryPath", ElementLibrary.getLibPath())
			.setDirectoryOnly(true);

	/**
	 * A jar containing custom java components
	 */
	public static final Key<File> SETTINGS_JAR_PATH = new Key.KeyFile("jarPath", new File(""));

	/**
	 * The manager which contains all the roms data
	 */
	public static final Key<ROMManger> ROMMANAGER = new Key<>("romContent", ROMManger.EMPTY);

	/**
	 * The type of the external process
	 */
	public static final Key.KeyEnum<Application.Type> APPLICATION_TYPE = new Key.KeyEnum<>("applicationType",
			Application.Type.Generic, Application.Type.values());
	/**
	 ...
	 */
	public static final Key.LongString EXTERNAL_CODE = new Key.LongString("Code").setRows(30).setColumns(80)
			.setLineNumbers(true);

	/**
	 * Path to ghdl
	 */
	public static final Key.KeyFile SETTINGS_GHDL_PATH = new Key.KeyFile("ghdlPath", new File("ghdl"));
