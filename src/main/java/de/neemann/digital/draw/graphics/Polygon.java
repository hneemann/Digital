...
public class Polygon implements Iterable<VectorInterface> {
	 ...
	 *
	 * @param c1
	 *            the first control point to add
	 * @param c2
	 *            the second control point to add
	 * @param p
	...
	/**
	 * Try's to add the given line to the polygon. Its possible to add a line if one
	 * of the points matches the first or the last point of the polygon. In that
	 * case the other point is added and true is returned. If it is not possible to
	 * add the line a false is returned
	 *
	 * @param p1
