...
public class VHDLExporter implements Closeable {
    ...
    private boolean useBoardClocking = true;
    ...
    /**
     * Used to enable or disable the board clocking.
     * Mainly used for tests. Allows to disable the clock dividers.
     *
     * @param useBoardClocking if true boar clocking/clock dividers are used.
     * @return this for chained calls
     */
    public VHDLExporter setUseBoardClocking(boolean useBoardClocking) {
        this.useBoardClocking = useBoardClocking;
        return this;
    }
    ...
    public VHDLExporter export(Circuit circuit) throws IOException {
        ...
        try {
            ...
            if (useBoardClocking && model.getClocks() != null && board != null)
